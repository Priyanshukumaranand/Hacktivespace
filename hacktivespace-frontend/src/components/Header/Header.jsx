        ...
        <div className="container">
          ...
          <ul className="navbar-nav ml-auto">
            ...
            <li className="nav-item dropdown">
              <a className="nav-link dropdown-toggle" href="/about" id="dropdown03" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">About</a>
              {/* <ul className="dropdown-menu" aria-labelledby="dropdown03">
                <li><a className="dropdown-item" href="/about">Our company</a></li>
             ...
             <li className="nav-item dropdown">
              ...
              {/* <ul className="dropdown-menu" aria-labelledby="dropdown05">
                <li><a className="dropdown-item" href="/blogs">Blog Grid</a></li>
