								...
								<div class="col-lg-6 col-md-6 mb-5">
									<div class="blog-item">
										...
										<div class="blog-item-content bg-white p-4">
											...
											<h3 class="mt-3 mb-3"><a href="/blog-page">Improve design with typography?</a></h3>
											<p class="mb-4">Non illo quas blanditiis repellendus laboriosam minima animi. Consectetur accusantium pariatur repudiandae!</p>

											<a href="/blog-page" class="btn btn-small btn-main btn-round-full">Learn More</a>
										</div>
									</div>
								</div>
								...
								<div class="col-lg-6 col-md-6 mb-5">
									<div class="blog-item">
										...
										<div class="blog-item-content bg-white p-4">
											...
											<h3 class="mt-3 mb-3"><a href="/blog-page">Interactivity connect consumer</a></h3>
											<p class="mb-4">Non illo quas blanditiis repellendus laboriosam minima animi. Consectetur accusantium pariatur repudiandae!</p>
								...
								<div class="col-lg-6 col-md-6 mb-5">
									<div class="blog-item">
										...
										<div class="blog-item-content bg-white p-4">
											...
											<h3 class="mt-3 mb-3"><a href="/blog-page">Marketing Strategy to bring more affect</a></h3>
											<p class="mb-4">Non illo quas blanditiis repellendus laboriosam minima animi. Consectetur accusantium pariatur repudiandae!</p>
